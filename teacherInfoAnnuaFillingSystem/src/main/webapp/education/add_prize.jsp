...
<script type="text/javascript">
	...
	<body>
    	<div class="alert alert-info">当前位置<b class="tip"></b>教学管理<b class="tip"></b>添加获奖信息</div>

    	<form method="post" action="../prizeServlet/save.do" enctype="multipart/form-data">
    	...
    	<table class="table table-striped table-bordered table-condensed list">
        	<tbody>
            	...
            	<tr>
                	...
                	<td width="500">
                    	<input id="ppath" name="ppath" type="file" /></td>
            	</tr>
            	<tr>
                	<td>获奖时间<font color="FF0000">*</font></td>
                	<td>
                    	<input class="ipt datepicker" size="16" type="text" id="pdate" name="pdate" />
            	...
            	<tr>
                	...
                	<td>
                    	<input id="pdepart" name="pdepart" type="text" />
                	</td>
                	<td>获奖等级<font color="FF0000">*</font></td>
                	<td>
                    	<input id="diploma" name="diploma" type="text" />
                	</td>
            	</tr>
            	<tr>
