...
<script type="text/javascript">
	...
	<body>
    	<div class="alert alert-info">当前位置<b class="tip"></b>科研管理<b class="tip"></b>添加科研成果</div>

    	<form method="post" action="${pageContext.request.contextPath}/researchResultServlet/save" enctype="multipart/form-data">
    	...
    	<table class="table table-striped table-bordered table-condensed list">
        	<tbody>
            	...
            	<tr>
                	...
                	<td width="500">
                    	<input id="rrname" name="rrname" type="text" />
                	</td>
                	<td width="500">上传科研项目<font color="FF0000">*</font></td>
                	<td width="500">
                    	<input id="rrpath" name="rrpath" type="file" /></td>
            	</tr>
            	<tr>
