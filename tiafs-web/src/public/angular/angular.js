...
function $CompileProvider($provide, $$sanitizeUriProvider) {
  ...
  this.$get = [
    ...
    function replaceWith($rootElement, elementsToRemove, newNode) {
      ...
      // event listeners (which is the demoProject.main use of private data) wouldn't work anyway.
 ...
 *
 *  There are two demoProject.main differences:
 *
 ...
 *
 * For the general details about this service in Angular, read the demoProject.main page for {@link ng.$sce
