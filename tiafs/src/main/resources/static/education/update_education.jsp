...
<script type="text/javascript">
	...
	<body>
    	...
    	<form method="post" action="../educationServlet/update.do">
    	...
    	<table class="table table-striped table-bordered table-condensed list">
        	<tbody>
            	...
            	<tr>
                	...
                	<td width="500">
                    	<input id="eduname" name="eduname" type="text" value="${education.eduname }"/>
                	</td>
                	<td width="500">班级学生人数<font color="FF0000">*</font></td>
                	<td width="500">
                    	<input id="edustudent" name="edustudent" value="${education.edustudent }" type="text" /></td>
            	</tr>
            	<tr>
                	<td>授课时间<font color="FF0000">*</font></td>
                	<td>
                    	<input id="edudate" name="edudate" value="${education.edudate }" type="text" /></td>
                    <td>学时<font color="FF0000">*</font></td>
                	<td>
                    	<input id="edutime" name="edutime" value="${education.edutime }" type="text" /></td>
            	</tr>
            	<tr>
                	<td>工作量<font color="FF0000">*</font></td>
                	<td>
                    	<input id="workload" name="workload" value="${education.workload }" type="text" />
                	</td>
                	<td>质量系数<font color="FF0000">*</font></td>
                	<td>
                    	<input id="mass" name="mass" value="${education.mass }" type="text" />
                	</td>
            	</tr>
            	<tr>
                	<td>授课分值<font color="FF0000">*</font></td>
                	<td colspan="3">
                    	<input id="eduscore" name="eduscore" value="${education.eduscore }" type="text" /></td>
            	</tr>
        	</tbody>
        	<tfoot>
            	<tr>
